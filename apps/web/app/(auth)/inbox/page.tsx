    ...
    messages: [
      {
        ...
        sender: "user",
        senderName: "You",
        body: "Hi Sarah, I noticed Stripe is scaling its sales team. Our AI SDR platform automates personalized outreach at scale — would love to show you how it could help your team hit quota faster.",
    ...
    messages: [
      {
        ...
        sender: "user",
        senderName: "You",
        body: "Hi David, I know Figma is growing fast. Our platform lets one SDR do the work of five — fully AI-driven prospecting, personalization, and follow-ups. Interested in learning more?",
